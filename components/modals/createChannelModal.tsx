...
const formSchema = z.object({
    name: z.string().min(1, {message: 'Channel name is required!!'}).refine(name => name !== 'General' && name !== 'general', {message: "Channel name can't be 'General' or 'general'"}),
                            ...
                            <FormField control={form.control} name='name' 
                                render={({field}) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input disabled={isLoading} className='bg-zinc-100/50 border-0 focus-visible:ring-0 text-gray-950 focus-visible:ring-offset-0' placeholder='Enter Channel Name' {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                              ...
                              render={({field}) => (
                                <FormItem>
                                    ...
                                    <Select disabled={isLoading} onValueChange={field.onChange} defaultValue={field.value}>
                                        <FormControl>
                                            <SelectTrigger className='bg-gray-50 border-0 focus:ring-0 text-black ring-offset-0 focus:ring-offset-0 capitalize outline-none'>
