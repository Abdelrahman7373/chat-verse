...
export const ServerSidebar = async ({serverId}: ServerSidebarProps) => {
    ...
    const server = await db.server.findUnique({
        where: {id: serverId},
        include: { channels: {orderBy: {createdAt: 'asc',},}, members: {include:{profile: true,}, orderBy: {role:'asc',},} },
    });
    ...
    return (
        <div className="flex flex-col h-full text-primary w-60 dark:bg-[#2B2D31] bg-gray-50">
