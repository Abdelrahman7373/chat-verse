...
export const EmojiPicket = ({onChange}:EmojiPicketProps) => {
    const {resolvedTheme} = useTheme();

    return (
        <Popover>
            <PopoverTrigger>
                <Smile className="text-zinc-400 dark:text-zinc-400 hover:text-zinc-500 dark:hover:text-zinc-300 transition" />
            </PopoverTrigger>
